<%-- 
    Document   : DTrans_EditTerima
    Created on : Apr 16, 2017, 8:34:13 PM
    Author     : ASJoker76
--%>
...
<html>
	...
	<div class="ear-piece">
        ...
        <form action="Terima_Edit" method="POST">
            <%
                ResultSet rs = (ResultSet) request.getAttribute("dataeditterima");
                if (rs.next()) {
                %>
                   <%
                        Date ys = new Date();
                   ...
                   Tanggal Terima       : <input readonly type="text" name="tanggalterima" class="form-control" value="<% out.println(s.format(ys)); %>"><br>
                   Status               : <input readonly type="text" name="status" class="form-control" value="Terima"><br>
