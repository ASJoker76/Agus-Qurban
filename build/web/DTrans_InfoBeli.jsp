<%-- 
    Document   : DTrans_InfoBeli
    Created on : Apr 15, 2017, 12:20:42 PM
    Author     : ASJoker76
--%>
        ...
        <header id="header" role="banner">		
		    ...
		    <div class="row">	        		
		       ...
		       <ul class="nav navbar-nav navbar-right">                 
		                ...
		                <li class="scroll active"><a href="http://<% out.println(request.getServerName()); %>:8080/IAQurban/DTrans_Infobeli?idcust=<% out.println(idcust); %>">Daftar Pembelian</a></li>                         
     ...
     <section id="explore">
		<div class="container">
         ...
         <table border='1' cellpadding='10' cellspacing='0'>
            ...
            <tbody>
                <%
                    ResultSet rs = (ResultSet) request.getAttribute("dataidcustbeli");
                    if (rs != null){
                        while(rs.next()){
                            %>
