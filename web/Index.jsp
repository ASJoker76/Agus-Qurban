<%-- 
    Document   : Index
    Created on : Apr 7, 2017, 2:54:57 AM
    Author     : ASJoker76
--%>
<%
...
<html>
    ...
    <body>
		    ...
		    <div class="row">	        		
		        ...
		        <div class="collapse navbar-collapse">
		            <ul class="nav navbar-nav navbar-right">                 
		                ...
		                <li class="scroll"><a href="http://<% out.println(request.getServerName()); %>:8080/IAQurban/Hewan_Index?idcust=<% out.println(idcust); %>">MyQurban</a></li>                         
                                <li class="scroll"><a href="Logout_Process">LogOut</a></li>      
		            </ul>
		        </div>
		    </div>
                </div>
		...
		<div class="container">
            ...
            <form method="post" action="Hewan_SearchIndex">
