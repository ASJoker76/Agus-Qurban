<%-- 
    Document   : DTrans_EditPembayaran
    Created on : Apr 15, 2017, 12:52:18 PM
    Author     : ASJoker76
--%>
...
<html>
	...
	<div class="ear-piece">
        ...
        <form action="Pembayaran_Edit" method="POST">
            <%
                ResultSet rs = (ResultSet) request.getAttribute("dataeditpembayaran");
                if (rs.next()) {
                %>
                   <%
                        Date ys = new Date();
                   ...
                   Tanggal Pembayaran   : <input readonly type="text" name="tanggalpembayaran" class="form-control" value="<% out.println(s.format(ys)); %>"><br>
                   Status               : <input readonly type="text" name="status" class="form-control" value="Pembayaran"><br>
