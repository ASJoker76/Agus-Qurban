<%-- 
    ...
    Created on : Apr 15, 2017, 4:35:01 PM
    Author     : ASJoker76
--%>
		    ...
		    <div class="row">	        		
		        ...
		        <div class="collapse navbar-collapse">
		            <ul class="nav navbar-nav navbar-right">                 
		                <li class="scroll"><a href="http://<% out.println(request.getServerName()); %>:8080/IAQurban/Admin_Index">Home</a></li>
		                <li class="scroll active"><a href="http://<% out.println(request.getServerName()); %>:8080/IAQurban/Admin_Login.jsp">Login</a></li>                         
		              </ul>
		        </div>
		    </div>
                </div>
